...
local logins = {
          { '--addic7ed', 'blah183', 'Nk&YNHAw29G!95!' },
--          { '--legendastv', 'USERNAME', 'PASSWORD' },
          { '--opensubtitles', 'blah183', 'Nk&YNHAw29G!95!' },
...
-- mp.add_key_binding('b', 'download_subs2', download_subs)
mp.add_key_binding('n', 'download_subs', download_subs2)
